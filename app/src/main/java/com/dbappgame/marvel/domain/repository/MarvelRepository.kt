...
interface MarvelRepository {
    ...
    fun getComics(characterId: Int): Maybe<BaseResult<List<Comic>>>
    fun getSeries(characterId: Int): Maybe<BaseResult<List<Series>>>
    fun insertData(marvelCharacter: List<MarvelCharacter>): Completable
